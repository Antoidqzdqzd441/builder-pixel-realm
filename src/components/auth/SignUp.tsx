...
export const SignUp: React.FC<SignUpProps> = ({ onToggleMode }) => {
  ...
  const { signUpWithEmail, signInWithGoogle, signInWithGoogleRedirect } = useAuth();
      ...
      <div className="max-w-md w-full">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Créez votre compte créateur</p>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Décrivez votre travail créatif..."
              />
            </div>
          ...
          <div className="text-center mt-4">
            <p className="text-xs text-gray-500">
              🎁 Vous recevrez 25 points gratuits à l'inscription !
            </p>
          </div>
        </motion.div>
      </div>
